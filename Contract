/**
 *Submitted for verification at BscScan.com on 2021-02-07 July 2st 
*/

/**
  

   #BUBBA features:slippage 9%
...
contract Bubba is Context, IERC20, Ownable {
    ...
    string private _name = "Bubba";
    string private _symbol = "BUBBA";
    ...
    address public marketingWallet = 0x7F4F201eF2d2C89dC8491CECDe7bbf5fD0ae08f5;
